...
var addBlankImage = function addBlankImage(options, html, data) {
  ...
  var imgTag = "<img src=\"" + options.baseUrl + "/blank-image/" + jwtImg + "\" />";
...
var linkRE = /(<a\s+(?:[^>]*?\s+)?href=")([^"]*)(")/gi;
var patchLinks = function patchLinks(options, html, data) {
  return html.replace(linkRE, function (_, first, link, end) {
    if (link.match(/^#/)) {
        ...
        return Promise.resolve(_catch(function () {
          ...
          var _temp5 = function () {
            if (options.getSendOptionsBeforeSend) {
              return Promise.resolve(options.getSendOptionsBeforeSend(sendOptions)).then(function (_options$getSendOptio) {
                sendOptions = _options$getSendOptio;
              });
            }
          }();
...
export { expressApp, sendMail };
//# sourceMappingURL=nodemailer-mail-tracking.esm.js.map
